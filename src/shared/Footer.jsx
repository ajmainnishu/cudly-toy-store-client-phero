...
const Footer = () => {
    return (
        <div className='bg-base-200'>
            {/* footer up */}
            <footer className="footer p-10 w-12/12 md:w-10/12 mx-auto text-base-content">
                {/* item 1 */}
                <nav>
            ...
            {/* footer down */}
            <footer className="footer px-10 py-4 w-12/12 md:w-10/12 mx-auto border-t bg-base-200 text-base-content border-base-300">
